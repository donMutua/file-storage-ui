      ...
      <div className="flex h-full grow flex-col">
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] px-10 py-3">
          <div className="flex items-center gap-4 text-[#111418]">
            ...
            <h2 className="text-[#111418] text-lg font-bold leading-tight tracking-[-0.015em]">Cloud.io</h2>
          </div>
          <div className="flex flex-1 justify-end gap-8">
            <div className="flex items-center gap-9">
              ...
              <Link className="text-[#111418] text-sm font-medium leading-normal" href="/product-tour">
                Product Tour
              </Link>
              <Link className="text-[#111418] text-sm font-medium leading-normal" href="/pricing">
                Pricing
              </Link>
              <Link className="text-[#111418] text-sm font-medium leading-normal" href="/docs">
                Docs
              </Link>
            </div>
            ...
            <div className="@container">
              <div className="@[480px]:p-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'linear-gradient(rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.6) 100%), url("/colorful-art-hero.jpg")',
                  }}
                >
                  <div className="flex flex-col gap-2 text-left">
                    <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em]">
                      A new home for your Google Docs, Sheets, and Slides
                    </h1>
                    <h2 className="text-white text-sm font-normal leading-normal @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal">
                      Import your existing files or create new ones in our editor. Collaborate in real-time with other
                      users and store all of your files securely in Drive.
                    </h2>
                  </div>
                  <div className="flex-wrap gap-3 flex">
                    ...
                    >
                      <span className="truncate">See pricing</span>
                    </Link>
                  </div>
                </div>
              </div>
              ...
              {[
                ...
                <div key={index} className="flex flex-col gap-3 pb-3">
                  ...
                  <div>
                    ...
                    <p className="text-[#637588] text-sm font-normal leading-normal">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
